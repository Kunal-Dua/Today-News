		...
		<div className="card">
			...
			<div className="card-body">
				...
				<a href={props.newsUrl} className="btn btn-primary" target="_blank" rel="noreferrer">
					Read More
					<span class="position-absolute translate-middle badge rounded-pill bg-danger" style={{left : "88%"}}>
						{props.source?props.source:"Unknown"}<span class="visually-hidden">Source</span>
					</span>
				</a>
			</div>
		</div>
